...
struct TEXT_HDMI_STRUCT {
	...
	const uint8_t pad[0xD40];  //padding to make color_palette starts from 0x0000 2000
...
static volatile struct TEXT_HDMI_STRUCT* hdmi_ctrl = XPAR_HDMI_DINO_CONTROLLER_0_AXI_BASEADDR;
