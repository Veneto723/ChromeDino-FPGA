...
#
# Generated by export_simulation on Sat Nov 16 20:14:38 -0600 2024
#
################################################################################
...
'-reset_run' switch to the './dino_rom.sh' script.

./dino_rom.sh -reset_run
...
./dino_rom.sh -noclean_files

For more information on the script, please type './dino_rom.sh -help'.
